...
```
整理需求内容，保存为`requirements.md`。

### 步骤1：生成项目配置文件

#### 输入要求
- **输入文件**：`requirements.md`（需求文档）
- **执行命令**：
```bash
/init
```
...
#### 输入要求
- **输入文件**：`CLAUDE.md`(项目配置) + `requirements.md`(需求文档) + '技术文档写作规范.md'(文档写作规范)
- **提示词**：
```
请你根据目录下的需求文件:"requirements.md"，按照"技术文档写作规范.md"规定的格式，生成可执行的架构设计文档:"design.md"。
```
